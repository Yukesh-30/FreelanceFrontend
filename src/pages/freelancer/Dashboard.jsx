    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md text-center border border-gray-100">
                <h1 className="text-3xl font-serif font-bold text-gray-900 mb-2">Freelancer Dashboard</h1>
                <p className="text-gray-500 mb-8">Welcome! You have successfully logged in as a Freelancer.</p>
